...
<div class="container">
    ...
    <h3 class="text-center p-3 mb-3 bg-white font-weight-bolder text-monospace">게시글 작성</h3>
    ...
    <table class="table table-sm" summary="게시글 작성">
       ...
       <tbody>
         <tr>
           <th>제목</th>
           <td>
             <form:input class="form-control is-valid" type="text" path="btitle" placeholder="제목을 입력하세요" />
         ...
         <tr>
           <th>내용</th>
           <td>
             <form:textarea class="form-control is-valid" path="bcontent" rows="15" placeholder="본문내용을 입력하세요" />
