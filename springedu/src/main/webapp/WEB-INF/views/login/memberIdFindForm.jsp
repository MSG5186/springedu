...
<script>
    ...
    <div class="col-4">
<form:form class="form-signin" modelAttribute="idFind" action="${pageContext.request.contextPath }/login/findId">
  <div class="text-center mb-4">
    <img class="mb-4" src="/resources/images/login.jpg" alt="" width="150" height="150">
        <h1 class="h3 mb-3 font-weight-normal">아이디 조회</h1>
  ...
  <button id="btn1" class="btn btn-lg btn-primary btn-block" type="submit">아이디 찾기</button>
