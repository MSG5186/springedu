...
/*
 * input :  RecordCriteria(요청페이지,한페이지에보여줄 레코드수), 
 *          totalRec(총레코드수), 한페이지에 보여줄 페이지수
 * ouput : 시작페이지,종료페이지,최종마지막페이지,이전버튼표시유무,다음버튼표시유무
 */
...
public class PageCriteria {
	...
	public String toString() {
		return "PageCriteria [pageNumberPerPage=" + pageNumberPerPage + ", startPage=" + startPage + ", endPage=" + endPage
